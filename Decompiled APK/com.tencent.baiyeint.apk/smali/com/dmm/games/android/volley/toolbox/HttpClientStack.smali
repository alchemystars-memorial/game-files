.class public Lcom/dmm/games/android/volley/toolbox/HttpClientStack;
.super Ljava/lang/Object;
.source "HttpClientStack.java"

# interfaces
.implements Lcom/dmm/games/android/volley/toolbox/HttpStack;


# annotations
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/dmm/games/android/volley/toolbox/HttpClientStack$HttpPatch;
    }
.end annotation
...
.method public constructor <init>(Lorg/apache/http/client/HttpClient;)V
    ...
    iput-object p1, p0, Lcom/dmm/games/android/volley/toolbox/HttpClientStack;->mClient:Lorg/apache/http/client/HttpClient;
...
.method static createHttpRequest(Lcom/dmm/games/android/volley/Request;Ljava/util/Map;)Lorg/apache/http/client/methods/HttpUriRequest;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0}, Lcom/dmm/games/android/volley/Request;->getMethod()I
    ...
    :pswitch_0
    new-instance p1, Lcom/dmm/games/android/volley/toolbox/HttpClientStack$HttpPatch;

    invoke-virtual {p0}, Lcom/dmm/games/android/volley/Request;->getUrl()Ljava/lang/String;

    move-result-object v1

    invoke-direct {p1, v1}, Lcom/dmm/games/android/volley/toolbox/HttpClientStack$HttpPatch;-><init>(Ljava/lang/String;)V

    invoke-virtual {p0}, Lcom/dmm/games/android/volley/Request;->getBodyContentType()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1, v0, v1}, Lcom/dmm/games/android/volley/toolbox/HttpClientStack$HttpPatch;->addHeader(Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {p1, p0}, Lcom/dmm/games/android/volley/toolbox/HttpClientStack;->setEntityIfNonEmptyBody(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Lcom/dmm/games/android/volley/Request;)V
    ...
    :pswitch_8
    invoke-virtual {p0}, Lcom/dmm/games/android/volley/Request;->getPostBody()[B
    ...
    invoke-virtual {p0}, Lcom/dmm/games/android/volley/Request;->getPostBodyContentType()Ljava/lang/String;
...
.method private static setEntityIfNonEmptyBody(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Lcom/dmm/games/android/volley/Request;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public performRequest(Lcom/dmm/games/android/volley/Request;Ljava/util/Map;)Lorg/apache/http/HttpResponse;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1, p2}, Lcom/dmm/games/android/volley/toolbox/HttpClientStack;->createHttpRequest(Lcom/dmm/games/android/volley/Request;Ljava/util/Map;)Lorg/apache/http/client/methods/HttpUriRequest;

    move-result-object v0

    invoke-static {v0, p2}, Lcom/dmm/games/android/volley/toolbox/HttpClientStack;->addHeaders(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/util/Map;)V
    ...
    invoke-virtual {p0, v0}, Lcom/dmm/games/android/volley/toolbox/HttpClientStack;->onPrepareRequest(Lorg/apache/http/client/methods/HttpUriRequest;)V
    ...
    iget-object p1, p0, Lcom/dmm/games/android/volley/toolbox/HttpClientStack;->mClient:Lorg/apache/http/client/HttpClient;
