.class public Lcom/intlgame/tools/apkchannel/v2/ApkSignatureSchemeV2Verifier;
...
.method private static findApkSignatureSchemeV2Block(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0}, Lcom/intlgame/tools/apkchannel/v2/ApkSignatureSchemeV2Verifier;->checkByteOrderLittleEndian(Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {p0, v1, v0}, Lcom/intlgame/tools/apkchannel/v2/ApkSignatureSchemeV2Verifier;->sliceFromTo(Ljava/nio/ByteBuffer;II)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0, v2}, Lcom/intlgame/tools/apkchannel/v2/ApkSignatureSchemeV2Verifier;->getByteBuffer(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
    ...
    :cond_1
    new-instance v1, Lcom/intlgame/tools/apkchannel/v2/ApkSignatureSchemeV2Verifier$SignatureNotFoundException;
    ...
    invoke-direct {v1, p0}, Lcom/intlgame/tools/apkchannel/v2/ApkSignatureSchemeV2Verifier$SignatureNotFoundException;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0}, Lcom/intlgame/tools/apkchannel/v2/ApkSignatureSchemeV2Verifier$SignatureNotFoundException;-><init>(Ljava/lang/String;)V
...
.method static findApkSigningBlock(Ljava/io/RandomAccessFile;J)Lcom/intlgame/tools/apkchannel/v2/Pair;
    .locals 7
    ...
    invoke-static {v0, p0}, Lcom/intlgame/tools/apkchannel/v2/Pair;->create(Ljava/lang/Object;Ljava/lang/Object;)Lcom/intlgame/tools/apkchannel/v2/Pair;
...
.method static findApkSigningBlockWithId(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
    ...
    :cond_1
    new-instance p1, Lcom/intlgame/tools/apkchannel/v2/ApkSignatureSchemeV2Verifier$SignatureNotFoundException;
    ...
    invoke-direct {p1, p0}, Lcom/intlgame/tools/apkchannel/v2/ApkSignatureSchemeV2Verifier$SignatureNotFoundException;-><init>(Ljava/lang/String;)V
...
.method static getCentralDirOffset(Ljava/nio/ByteBuffer;J)J
    ...
    invoke-static {p0}, Lcom/intlgame/tools/apkchannel/v2/ZipUtils;->getZipEocdCentralDirectoryOffset(Ljava/nio/ByteBuffer;)J
    ...
    invoke-static {p0}, Lcom/intlgame/tools/apkchannel/v2/ZipUtils;->getZipEocdCentralDirectorySizeBytes(Ljava/nio/ByteBuffer;)J
...
.method static getEocd(Ljava/io/RandomAccessFile;)Lcom/intlgame/tools/apkchannel/v2/Pair;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0}, Lcom/intlgame/tools/apkchannel/v2/ZipUtils;->findZipEndOfCentralDirectoryRecord(Ljava/io/RandomAccessFile;)Lcom/intlgame/tools/apkchannel/v2/Pair;
...
.method public static hasSignature(Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Lcom/intlgame/tools/apkchannel/v2/ApkSignatureSchemeV2Verifier;->findApkSignatureSchemeV2Block(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    :try_end_1
    ...
    :try_end_2
    .catch Lcom/intlgame/tools/apkchannel/v2/ApkSignatureSchemeV2Verifier$SignatureNotFoundException; {:try_start_2 .. :try_end_2} :catch_0
    ...
    invoke-direct {p0, v1}, Lcom/intlgame/tools/apkchannel/v2/ApkSignatureSchemeV2Verifier$SignatureNotFoundException;-><init>(Ljava/lang/String;)V
    ...
    throw p0
    :try_end_5
    .catch Lcom/intlgame/tools/apkchannel/v2/ApkSignatureSchemeV2Verifier$SignatureNotFoundException; {:try_start_5 .. :try_end_5} :catch_0
