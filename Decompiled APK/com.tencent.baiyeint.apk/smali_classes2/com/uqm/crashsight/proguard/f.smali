...
.method public constructor <init>(Landroid/content/Context;Ljava/util/List;)V
    ...
    sget-object v1, Lcom/uqm/crashsight/proguard/f;->a:Ljava/lang/String;
    ...
    sget v1, Lcom/uqm/crashsight/proguard/f;->b:I

    const/4 v2, 0x0

    invoke-direct {p0, p1, v0, v2, v1}, Landroid/database/sqlite/SQLiteOpenHelper;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;I)V

    iput-object p1, p0, Lcom/uqm/crashsight/proguard/f;->c:Landroid/content/Context;

    iput-object p2, p0, Lcom/uqm/crashsight/proguard/f;->d:Ljava/util/List;
...
.method public final declared-synchronized onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Lcom/uqm/crashsight/proguard/f;->d:Ljava/util/List;
    :try_end_1
...
.method public final declared-synchronized onDowngrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    :cond_1
    invoke-direct {p0, p1}, Lcom/uqm/crashsight/proguard/f;->a(Landroid/database/sqlite/SQLiteDatabase;)Z

    move-result p2

    if-eqz p2, :cond_2

    invoke-virtual {p0, p1}, Lcom/uqm/crashsight/proguard/f;->onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1
    ...
    iget-object p1, p0, Lcom/uqm/crashsight/proguard/f;->c:Landroid/content/Context;

    sget-object p2, Lcom/uqm/crashsight/proguard/f;->a:Ljava/lang/String;
